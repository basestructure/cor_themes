...
//* Enqueue Roboto 100 300 400 500 700 900 & Lato 100 300 400 700 900
/*add_action( 'wp_enqueue_scripts', 'gf_robotolato' );
function gf_robotolato() {
	wp_enqueue_style( 'google-font-robotolato', '//fonts.googleapis.com/css?family=Roboto:100,300,400,500,700,900|Lato:100,300,400,700,900', array(), CHILD_THEME_VERSION );
}*/
...
//add_action( 'wp_footer', 'js_menu', 2 );
function js_menu() {
