...
define( 'CHILD_THEME_VERSION', '2.3.0.1.1' );
	...
	function spt_sitefooter() {
		...
		<div class="module-credits">
			<div class="module-wrap">
				...
				<div class="copyright">Copyright © 2017 UnderstandingRelatonships.com | All Rights Reserved | <a href="http://www.understandingrelationships.com/privacy-policy/">Privacy Policy</a><br>
	...
	function base226_cswbefore() {
		if (is_front_page()) {
			genesis_widget_area( 'cswbefore-home', array(
				'before' => '<div class="cswbefore widget-area"><div class="areawrap">',
				'after' => '</div></div>',
			) );
		} else {
